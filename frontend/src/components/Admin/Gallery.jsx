...
function Gallery() {
  ...
  useEffect(() => {
    const fetchGalleries = async () => {
      try {
        const response = await axios.get('http://localhost:3000/gallery/all-galleries'); // Replace with your actual API endpoint
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/gallery/delete-gallery/${id}`); // Replace with your actual API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/gallery/upload-gallery', formDataToSend, {
        headers: {
