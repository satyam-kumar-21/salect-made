...
function Review() {
  ...
  useEffect(() => {
    const fetchRatings = async () => {
      try {
        const response = await axios.get('http://localhost:3000/rating/get-all-ratings'); // Replace with your actual API endpoint
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/rating/delete-rating/${id}`); // Replace with your actual API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/rating/create-rating', formDataToSend, {
        headers: {
