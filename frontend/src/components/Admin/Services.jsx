...
function Services() {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        const response = await axios.get('http://localhost:3000/service/get-all-services'); // Replace with your actual API endpoint
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/service/delete-service/${id}`); // Replace with your actual API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/service/create-service', formDataToSend, {
        headers: {
