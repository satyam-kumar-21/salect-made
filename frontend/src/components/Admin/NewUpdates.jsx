...
function NewUpdates() {
  ...
  useEffect(() => {
    const fetchNewUpdates = async () => {
      try {
        const response = await axios.get('http://localhost:3000/new-update/get-all-new-updates'); // Replace with your actual API endpoint
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/new-update/delete-new-update/${id}`); // Replace with your actual API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/new-update/create-new-update', formDataToSend, {
        headers: {
